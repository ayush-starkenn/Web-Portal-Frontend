...
const AnalyticsThreshold = () => {
  ...
  // Delete api call
  const handleDeleteAT = (threshold_uuid, at_name) => {
    axios
      .put(
      ...
      .then((res) => {
        ...
        toastRef.current.show({
          severity: "success",
          summary: "Success",
          detail: `Analytic Threshold ${at_name} deleted successfully`,
          life: 3000,
        });
      })
      .catch((err) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        toastRef.current.show({
          severity: "success",
          summary: "Success",
          detail: `Analytics Threshold ${formData.title} Score Generated Successfully.`,
          life: 3000,
        });
        setIsDialogVisible(false);
        resetFormFields();
