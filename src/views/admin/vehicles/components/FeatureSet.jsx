      ...
      axios
        ...
        .then((res) => {
          toastRef.current.show({
            severity: "success",
            summary: "Success",
            detail: `Feature Set ${postData.featureset_name} updated successfully`,
            life: 3000,
          });
          setTimeout(() => {
            closeDialog();
      ...
      <form onSubmit={handleSubmit}>
        <div className="card">
          <div className="mt-2 flex" style={{ flexDirection: "column" }}>
            <label
              htmlFor="username"
              className="mt-4 font-bold dark:text-gray-300"
            >
              Feature Set Name
            </label>
            <InputText
        ...
        <div className="card justify-content-center mb-3 mt-2 flex gap-4">
          <div className="align-items-center flex">
            <input
              ...
              onChange={handleDetails}
            />
            <label htmlFor="CASen" className="ml-2 dark:text-gray-300">
              Enable
            </label>
          </div>
          <div className="align-items-center flex">
            <input
              ...
              onChange={handleDetails}
            />
            <label htmlFor="CASdis" className="ml-2 dark:text-gray-300">
              Disable
            </label>
          </div>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="brk_bypas_typ" className="dark:text-gray-300">
              Brake Bypass type
            </label>
            <Dropdown
              name="brk_bypas_typ"
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[30vw]">
            <label htmlFor="brk_type" className="dark:text-gray-300">
              Brake type
            </label>
            <Dropdown
              name="brk_type"
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="brk_bypas_dur" className="dark:text-gray-300">
              Brake Bypass Duration
            </label>
            <InputText
              type="number"
              id="brk_bypas_dur"
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[30vw]">
            <label htmlFor="Sensor_res2" className="dark:text-gray-300">
              Reserved 2
            </label>
            <InputText
              type="number"
        ...
        <div className="flex justify-between">
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="spdSet_spd" className="dark:text-gray-300">
              Speed
            </label>
            <InputText
              type="number"
        ...
        <hr style={{ borderColor: "#333" }} />
        <p className="mt-4 font-bold dark:text-gray-300">RFID</p>
        ...
        <div className="flex justify-between">
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="spd_rtc" className="dark:text-gray-300">
              RTC
            </label>
            <InputText
              type="number"
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[30vw]">
            <label htmlFor="brk_cyl" className="dark:text-gray-300">
              Brake Cylinder
            </label>
            <InputText
              type="number"
        ...
        <div className="flex justify-between">
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="spd_err_fuel" className="dark:text-gray-300">
              Fuel
            </label>
            <InputText
              type="number"
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[30vw]">
            <label htmlFor="spd_err_ldr" className="dark:text-gray-300">
              Lidar
            </label>
            <InputText
              type="number"
        ...
        <div className="flex justify-between">
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="spd_err_load" className="dark:text-gray-300">
              Load
            </label>
            <InputText
              type="number"
        ...
        <hr style={{ borderColor: "#333" }} />
        <p className="mt-4 font-bold dark:text-gray-300">Temperature</p>
        {invalidFields.includes("temp_sts") && (
          <span className="p-error">Please select any option.</span>
        )}
        <div className="mb-3 mt-2 flex flex-wrap gap-3 dark:text-gray-300">
          <div className="align-items-center flex">
            <input
              type="radio"
              id="temp_sts"
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[30vw]">
            <label htmlFor="temp_thrsh" className="dark:text-gray-300">
              Threshold
            </label>
            <InputText
              type="number"
          ...
          <div className="field my-3 w-[30vw]">
            <label htmlFor="temp_res1" className="dark:text-gray-300">
              Reserved 1
            </label>
            <InputText
              type="number"
