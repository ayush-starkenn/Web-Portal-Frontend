...
const AddFeatureSet = ({ onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (onSuccess) {
        onSuccess(featuresetData.featureset_name);
      }
    } catch (err) {
      toastRef.current.show({
        severity: "error",
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[35vw]">
        ...
        <div className="flex justify-between">
          ...
          <div className="field my-3 w-[30vw]">
            ...
            <InputText
              ...
              onChange={handleData}
              disabled={values.speedSource !== "4"}
              placeholder="Enter a value"
              autoComplete="off"
              value={values.spdSet_spd}
            />
        ...
        <div className="flex justify-between">
          <div className="field my-3 w-[30vw]">
            ...
            <InputText
              ...
              placeholder="Enter a value"
              autoComplete="off"
              disabled={values.temp_sts === "0"}
              value={values.temp_thrsh}
            />
          </div>
          <div className="field my-3 w-[30vw]">
