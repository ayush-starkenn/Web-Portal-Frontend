...
const OngoingTable = () => {
  ...
  return (
    <>
      <Card className="!z-5 s-screen relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 dark:!bg-navy-800 dark:text-white dark:shadow-none">
