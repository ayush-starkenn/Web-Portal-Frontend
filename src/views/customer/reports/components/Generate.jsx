              ...
              <div className="mt-8">
                <span className="p-float-label">
                  <MultiSelect
                    ...
                    optionLabel="name"
                    className={`rounded-lg border border-gray-300 shadow-sm dark:bg-gray-900 dark:text-gray-300 dark:placeholder-gray-50 ${
              ...
              <div className="mt-8">
                <span className="p-float-label">
                  <Dropdown
                    ...
                    optionLabel="label"
                    optionValue="code"
                    className={`rounded-lg  border border-gray-300 shadow-sm dark:bg-gray-800 dark:placeholder-gray-50 ${
