...
const Marketplace = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        toastRef.current.show({
          severity: "success",
          summary: "Success",
          detail: `Vehicle ${data.vehicle_name} updated successfully!`,
          life: 3000,
        });
      })
      .catch((err) => {
  ...
  const deleteVehicle = (vehicle_uuid, token, v_name) => {
    axios
      .put(
      ...
      .then((res) => {
        ...
        toastRef.current.show({
          severity: "success",
          summary: "Success",
          detail: `Vehicle ${v_name} deleted successfully!`,
          life: 3000,
        });
      })
      .catch((err) => {
  ...
  return (
    <>
      ...
      <Dialog
        ...
        style={{ width: "70vw", maxWidth: "100vw" }}
      >
