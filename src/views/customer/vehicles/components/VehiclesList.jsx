...
export default function VehiclesList({
  ...
  const handleDelete = () => {
    if (deleteId !== "") {
      deleteVehicle(deleteId, token, deleteVehicleName);
      DeleteDialog();
    }
  };
    ...
    <div>
      ...
      >
        ...
        <Column
          ...
          header="DMS"
          sortable
          className="border-b dark:border-b dark:bg-navy-800 dark:text-gray-200"
          style={{ minWidth: "5rem" }}
        ...
        <Column
          ...
          header="Action"
          className="action border-b dark:bg-navy-800 dark:text-gray-200"
          style={{ minWidth: "8rem" }}
        ></Column>
      </DataTable>
      {/* Edit vehicle Data */}
