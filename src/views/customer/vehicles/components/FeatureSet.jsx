      ...
      axios
        ...
        .then((res) => {
          toastRef.current.show({
            severity: "success",
            summary: "Success",
            detail: `Vehicle Feature Set ${editData.featureset_name} updated successfully`,
            life: 2000,
          });
          setTimeout(() => {
            closeDialog();
      ...
      axios
        ...
        .then((res) => {
          toastRef.current.show({
            severity: "success",
            summary: "Success",
            detail: `Feature Set ${featuresetDetails.featureset_name} updated successfully`,
            life: 3000,
          });
          setTimeout(() => {
            closeDialog();
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-3">
          ...
          <div className="field my-3 w-[30vw]">
            ...
            <Dropdown
              ...
              optionValue="value"
              placeholder={
                featuresetData.brk_bypas_typ
                  ? `Selected: ${featuresetData.brk_bypas_typ}`
                  : "Select an option"
              }
              style={{
                width: "24vw",
              ...
              name="brk_bypas_typ"
              onChange={handleDetails}
              value={featuresetData.brk_bypas_typ}
              className={`md:w-14rem h-11 w-full border dark:bg-gray-900 ${
          ...
          <div className="field my-3 w-[30vw]">
            ...
            <Dropdown
              ...
              optionValue="value"
              placeholder={
                featuresetData.brk_type
                  ? `Selected: ${featuresetData.brk_type}`
                  : "Select an option"
              }
              style={{
                width: "24vw",
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-3">
          <div className="field my-3 w-[30vw]">
            ...
            {invalidFields.includes("brk_bypas_dur") && (
              <small className="text-red-600">
                Brake bypass duration should be greater than 0 and less than 30
              </small>
            )}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-3">
          <div className="field my-3 w-[30vw]">
            ...
            {invalidFields.includes("cruiseactivationSpeed") && (
              <small className="text-red-600">
                Cruise activation speed should be greater than 0 and less than
                150
              </small>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-3">
          ...
          <div className="field my-3 w-[60vw]">
            <label htmlFor="Sensor_res2">Reserve 2</label>
            <InputText
              type="number"
              id="Sensor_res2"
              style={{
