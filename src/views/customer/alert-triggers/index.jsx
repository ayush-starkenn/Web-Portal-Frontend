...
const Triggers = () => {
    ...
    axios
      ...
      .then((res) => {
        toastRef.current.show({
          severity: "success",
          summary: "Success",
          detail: `Trigger ${editData.trigger_name} updated successfully!`,
          life: 3000,
        });
        setRefresh(!refresh);
      })
  ...
  //delete Function
  const deleteTrigger = (trigger_id, token, t_name) => {
    axios
      .put(
      ...
      .then(() => {
        toastRef.current.show({
          severity: "success",
          summary: "Success",
          detail: `Trigger ${t_name} deleted successfully!`,
          life: 3000,
        });
        setRefresh(!refresh);
      })
      .catch((err) => {
        toastRef.current.show({
          ...
          summary: "Error",
          detail:
            "Failed to edit trigger. Please try again." ||
